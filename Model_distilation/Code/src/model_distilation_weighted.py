...
#----------
print("Comecando aqui - com ponderação")
...
CLASS_WEIGHTS = torch.tensor([1.0, 10000.0, 10000.0], device=device).float()
...
checkpoint_path='best_spliceformerlite_distillation_weighted.pt'
